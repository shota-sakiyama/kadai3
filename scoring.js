...
$(document).ready(function(){
  ...
  function score_indicate(){
    ...
    let average =　subject_points.length
    $("#average_indicate").text(sum/average)
  ...
  function judgement(){
    ...
    $('#declaration').append(`<label id="alearA" class="alert alert-info">あなたの成績は${achievement}で${pass_or_failure}です</label>`);
  };
